    ...
    public partial class Solutions : Form
    {
        ...
        private void Plot_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // LTE
                LTE LES = new LTE(es.y, es.x, es.h, N, 1);
                LTE LIE = new LTE(es.y, es.x, es.h, N, 2);
                LTE LRK = new LTE(es.y, es.x, es.h, N, 2);
                //
                ...
                //chart 3 with LTE
                chart2LTE.Series[0].Points.DataBindXY(ES.x, LES.e);
                chart2LTE.Series[1].Points.DataBindXY(IE.x, LIE.e);
                chart2LTE.Series[2].Points.DataBindXY(RK.x, LRK.e);

                chart2LTE.ChartAreas[0].AxisX.Minimum = x0;
                chart2LTE.ChartAreas[0].AxisX.Maximum = X;
                //
        ...
        private void checkBox_Euler_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chart2LTE.Series[0].Enabled = checkBox_Euler.Checked;
        ...
        private void checkBox_Impr_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chart2LTE.Series[1].Enabled = checkBox_Impr.Checked;
        ...
        private void checkBox_RK_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chart2LTE.Series[2].Enabled = checkBox_RK.Checked;
